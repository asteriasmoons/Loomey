...
final class SubmittedReport {
    ...
    var conversationState: LumeyReportConversationState {
        get { LumeyReportConversationState(rawValue: conversationStateRawValue) ?? .notStarted }
